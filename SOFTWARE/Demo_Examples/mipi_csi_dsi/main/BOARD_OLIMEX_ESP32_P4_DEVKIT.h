...
/* For general */
#define ESP_PANEL_BOARD_EXPANDER_I2C_HOST_ID        (CONFIG_EXAMPLE_MIPI_I2C_PORT)     // Typically set to 0
/* For host */
#if !ESP_PANEL_BOARD_EXPANDER_SKIP_INIT_HOST
#define ESP_PANEL_BOARD_EXPANDER_I2C_CLK_HZ         (CONFIG_EXAMPLE_MIPI_I2C_FREQ)
                                                            // Typically set to 400K
...
#define ESP_PANEL_BOARD_EXPANDER_I2C_IO_SCL         (CONFIG_EXAMPLE_MIPI_I2C_SCL_PIN)
#define ESP_PANEL_BOARD_EXPANDER_I2C_IO_SDA         (CONFIG_EXAMPLE_MIPI_I2C_SDA_PIN)
